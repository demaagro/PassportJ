...
#[derive(Debug)]
pub struct PassportJSProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PassportJSProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PassportJS processing");
    
    let mut processor = PassportJSProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PassportJSProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PassportJSProcessor::new(false);
